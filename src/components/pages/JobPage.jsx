                        ...
                        <div className='grid grid-cols-1 md:grid-cols-70/30 w-full gap-6'>
                            ...
                            <aside className='bg-white rounded-lg shadow-md  p-6'>
                                ...
                                <div className='bg-white rounded-lg shadow-md mt-6 p-6'>
                                    ...
                                    <button className='bg-red-500 hover:bg-red-600 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block'>Delete Job</button>
                                </div>
                            </aside>
                        </div>
                    </div>
